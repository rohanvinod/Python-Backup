...
def create_border():
    ...
    img = ImageOps.expand(img,border=20,fill='black')#creates the inner border
    img = ImageOps.expand(img,border=100,fill='blue') #creates the middle border
    img = ImageOps.expand(img,border=50,fill='black')#creates outermost border
    img2 = Image.open('family.jpg')
    img.paste(img2, (10,20))
